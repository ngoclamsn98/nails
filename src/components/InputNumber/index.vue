    ...
    <div class="flex gap-x-[10px] items-start">
      ...
      <div class="flex flex-col h-[60px] flex-1 ">
        ...
        <div class="relative">
          ...
          />
          <div class="absolute right-0 flex items-center rounded-r-lg text-[12px] border-l border-gray-300 h-full top-0 w-[30px] text-black justify-center" v-if="isMoney">vnđ</div>
        </div>
